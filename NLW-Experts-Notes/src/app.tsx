...
// no tailwind as medidas são multiplicadas por 4x ex my-12 nada mais é margin no eixo y de 48px
// isso aqui space-y-6 da um espaçamento em todos os filhos menos no primeiro
